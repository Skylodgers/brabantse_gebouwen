...
DATATYPE_LOCATIONS.append('brabantse_gebouwen.datatypes')
FUNCTION_LOCATIONS.append('brabantse_gebouwen.functions')
ETL_MODULE_LOCATIONS.append('brabantse_gebouwen.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('brabantse_gebouwen.search_components')
...
SECRET_KEY = '4*zzvw^^p)n86m9=%(tmu3yt+0l#srpanj6+nfc%+ivwed#7@s'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'brabantse_gebouwen.urls'
...
ELASTICSEARCH_PREFIX = 'brabantse_gebouwen'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'brabantse_gebouwen.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'brabantse_gebouwen.wsgi.application'
...
SESSION_COOKIE_NAME = 'brabantse_gebouwen'
